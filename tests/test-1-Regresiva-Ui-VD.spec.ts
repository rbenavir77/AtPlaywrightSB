...
test('test Usuario invitado WPD', async ({ page }) => {
 ...
 // await page.getByPlaceholder('¿Qué estás buscando?').fill('mentholathum');
  ...
  //await page.locator('li').filter({ hasText: 'MentholatumPrincipio Activo: Alcanfor / Mentolformato:36 grs Topico' }).getByRole('button').click();
